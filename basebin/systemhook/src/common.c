...
#define JBD_MSG_SETUID_FIX 13
#define JBD_MSG_PROCESS_BINARY 11
#define JBD_MSG_DEBUG_ME 15
#define JBD_MSG_PROC_SET_DEBUGGED 14
#define JBD_MSG_PLATFORMIZE 16
