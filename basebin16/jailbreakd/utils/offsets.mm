...
void _offsets_init(void) {
    ...
    if ([device  isEqual: @"iPhone 7"]) {
        ...
        if (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"16.5.1")) {
            ...
            off_proc_set_ucred = 0xFFFFFFF0075D13A8;//0xFFFFFFF0075D1158;
            ...
            off_proc_updatecsflags = 0xFFFFFFF0075D0EC4;//FFFFFFF0075D0E34;
        } else if (SYSTEM_VERSION_EQUAL_TO(@"16.4.1")) {
